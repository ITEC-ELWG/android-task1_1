...
public class NoteList extends ListActivity {
    ...
    public void onResume(){
        super.onResume();
        updateCursor();     //update listview if database changed
    }
    ...
    private void addNote(){
        ...
        data.putSerializable("EDITE_MODE", Constant.EDITE_MODE.ADD);
    ...
    private void editeNote(long id){
        Intent intent = new Intent(this,NoteEditor.class);
        Bundle data = new Bundle();
        data.putSerializable("EDITE_MODE", Constant.EDITE_MODE.EDITE);
        data.putLong("ID",id);
        intent.putExtras(data);
        startActivity(intent);
    }
    ...
    private class ActionModeCallback implements ActionMode.Callback {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.note_list_select_menu_all:
                    ...
                    if( checkedCount<getListView().getCount() )
                        ...
                        for (int indedx = 0; indedx < getListView().getCount(); indedx++) getListView().setItemChecked(indedx, false);
        ...
        public void onDestroyActionMode(ActionMode mode) {
            for(int i=0; i<getListView().getCount(); i++) {
                ...
                getListView().getChildAt(i).setActivated(false);    // remove mutiple selected color
            }
